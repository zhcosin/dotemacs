...
(require 'org-page)
(setq op/site-main-title "长春阁")
(setq op/site-sub-title "无才可去补苍天，枉入红尘若许年")
(setq op/personal-github-link "http://zhcosin.github.io")
(setq op/repository-directory "F:/zhcosin.github.io")
